...
import { recordSaasPlatformAdminOperation } from "../database/index.js";
...
const resolveField = (field: string, variables: Record<string, unknown>): unknown => {
  if (scalarFields.has(field)) {
    if (field === "getCountryUrl") return "http://localhost:5050/saas-platform-admin-web";
...
export const SaasPlatformAdminGraphqlController = () => {
