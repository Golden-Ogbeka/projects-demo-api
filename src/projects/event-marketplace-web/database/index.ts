...
export const setupEventMarketplaceDatabase = () => {
  ...
  if (conversationCount.count === 0) {
    const convParticipants = JSON.stringify([{ _id: "user-1", email: "demo@example.com", username: "demo_seller", personalInformation: { profileImageLink: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200", firstName: "Demo", lastName: "Seller", address: { countryLabel: "Nigeria", city: "Ibadan" } } }, { _id: "user-3", email: "consumer@example.com", username: "demo_consumer", personalInformation: { profileImageLink: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200", firstName: "Demo", lastName: "Consumer", address: { countryLabel: "Nigeria", city: "Abuja" } } }]);
  ...
  if (stripeCustomerCount.count === 0) {
    sqlite.prepare(`INSERT INTO event_marketplace_stripe_customers (_id, email, name, invoice_prefix) VALUES ('cus-1', 'demo@example.com', 'Demo Seller', 'DEMO-INV')`).run();
